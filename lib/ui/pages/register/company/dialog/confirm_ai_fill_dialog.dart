...
class ConfirmAiFillDialog extends StatelessWidget {
  final Function(bool isConfirm) clickConfirm;
  const ConfirmAiFillDialog({super.key, required this.clickConfirm});
        ...
        child: Container(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                Text(
                  Strings.greatNowLetSFill,
                  style: Types.headerLogoTStyle,
                  textAlign: TextAlign.center,
                ),
                spacerVertical(8),
                Text(
                  Strings.thanksToOurHighTechAi,
                  style: Types.grayRegular24TStyle,
                  textAlign: TextAlign.center,
                ),
                spacerVertical(2),
                Text(
                  Strings.haveToDoIsToDoubleCheck,
                  style: Types.grayRegular24TStyle,
                  textAlign: TextAlign.center,
                ),
                spacerVertical(40),
