...
class CoreCandidateSkillsStep extends StatefulWidget {
  final Function() onNeedNextPage;
  final Function() onNeedPrewPage;
  const CoreCandidateSkillsStep(
      {super.key, required this.onNeedNextPage, required this.onNeedPrewPage});

  @override
  State<CoreCandidateSkillsStep> createState() =>
      _CoreCandidateSkillsStepState();
}

class _CoreCandidateSkillsStepState extends State<CoreCandidateSkillsStep> {
