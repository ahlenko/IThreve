...
class OtherInformationStep extends StatefulWidget {
  ...
  @override
  State<OtherInformationStep> createState() => _OtherInformationStepState();
}

class _OtherInformationStepState extends State<OtherInformationStep> {
        ...
        child: Column(
            ...
            children: [
              RegularBoltRegularText(
                firstText: Strings.whatOtherInformationWillYou,
              ),
              spacerVertical(12),
              Text(
                Strings.youCanAddAnythingHere,
