...
class RoleEssentialStep extends StatefulWidget {
  final Function() onNeedNextPage;
  final Function() onNeedPrewPage;
  const RoleEssentialStep(
      {super.key, required this.onNeedNextPage, required this.onNeedPrewPage});

  @override
  State<RoleEssentialStep> createState() => _RoleEssentialStepState();
}

class _RoleEssentialStepState extends State<RoleEssentialStep> {
  List<SelectedUnselected> items = [
    SelectedUnselected(title: 'Essential'),
    SelectedUnselected(title: 'Support'),
    SelectedUnselected(title: 'Nice to have'),
  ];
        ...
        child: Column(
            ...
            children: [
              RegularBoltRegularText(
                firstText: Strings.howEssentialIsThisRole,
              ),
              spacerVertical(65),
              Wrap(
